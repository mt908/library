...
public class BookAction {
	...
	public Object[][] initializTable(String[] columnNames) throws Exception{
 	 ...
 	 * 添加图书信息
 	 */
	public void addBookInformation (JTextField textFieldID,JTextField textFieldISBN, JTextField textFieldName
			...
			, JTextField textFieldBorrowPhone,JTable table) throws Exception {
	 ...
	 * 修改图书信息
	 */
	public void changeBookInformation (JTextField textFieldID,JTextField textFieldISBN, JTextField textFieldName
			,JTextField textFieldPrice, JTextField textFieldAuthor, JTextField textFieldPublishedHouse
			, JTextField textFieldBookCategory, JTextField textFieldBorrowerName
			, JTextField textFieldBorrowerPhone) throws Exception{
